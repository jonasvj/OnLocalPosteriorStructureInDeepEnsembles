"""
Adapted from: https://github.com/tencent-alchemy/Alchemy/blob/master/pyg/Alchemy_dataset.py
"""
#!/usr/bin/env python
# encoding: utf-8
...
class TencentAlchemyDataset(InMemoryDataset):
    ...
    def sdf_graph_reader(self, sdf_file):
        ...
        atom_numbers = node_attr.clone()[:,7].to(torch.int64)
        data = Data(
            x=node_attr,
...
if __name__ == '__main__':
    alchemy = TencentAlchemyDataset(root='data/alchemy', mode='test')
